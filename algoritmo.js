...
//Realizar un algoritmo de loteria entre 10 numeros, escoger un numero del 1 al 10, y mostrar si perdio o gano
function Adivinador() {
    let numeroElegido = parseInt(prompt("Elige un número del 1 al 10:"));
    ...
    if (numeroElegido < 1 || numeroElegido > 10) {
        ...
        alert("Por favor, elige un número válido entre 1 y 10.");
    } else if (numeroElegido === numeroGanador) {
        console.log("Lo has adivinado :D " + numeroGanador);
        alert("Lo has adivinado :D " + numeroGanador);
    } else {
        console.log("Casi lo logras " + numeroGanador);
        alert("Casi lo logras " + numeroGanador);
    }
}